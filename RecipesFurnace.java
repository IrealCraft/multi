...
public class RecipesFurnace {
    ...
    public RecipesFurnace() { // CraftBukkit - private -> public
        ...
        /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        this.registerRecipe(Block.ORECUIVRE.id, new ItemStack(Item.CUIVRE), 1.0F);
        this.registerRecipe(Block.ORECITRINE.id, new ItemStack(Item.CITRINE), 1.0F);
        this.registerRecipe(Block.OREEMERAUDE.id, new ItemStack(Item.EMERAUDE), 1.0F);
        this.registerRecipe(Block.ORESAPHIR.id, new ItemStack(Item.SAPHIR), 1.0F);
        this.registerRecipe(Block.ORERUBIS.id, new ItemStack(Item.RUBIS), 1.0F);
        this.registerRecipe(Block.GLOWSTONE.id, new ItemStack(Block.LANTERNE2), 0.7F);
        this.registerRecipe(Block.LANTERNE2.id, new ItemStack(Block.LANTERNE1), 0.7F);
        /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
